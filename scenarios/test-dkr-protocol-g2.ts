...
/**
 * DKR (re-sharing) protocol e2e over BLS12-381 G2 (scheme = 1).
 *
 * Mirror of test-dkr-protocol.ts. Same flow with the same old/new committee shapes,
 * but the on-chain `base_point` is the G2 generator. Verifies that DKG followed by
 * DKR round-trips correctly under the group-parametric plumbing.
 */
