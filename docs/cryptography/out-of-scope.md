...
- **Formal DKG / DKR / t-IBE secrecy theorems.** Only the VSS sharing-phase theorem ([`vss.md`](./vss.md) §2, Theorem 1) is currently formalized. DKG composition (Theorem 2), DKR composition (Theorem 3), and t-IBE adaptive-decryption security (Theorem 4) are sketched conceptually in their respective files but not yet written as formal game-based reductions.
